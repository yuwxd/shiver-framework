...
const { ComponentRouter } = require('./routing/ComponentRouter');
const { Scheduler } = require('./scheduler/Scheduler');
const { UserSessionStore } = require('./sessions/UserSessionStore');
const { FeatureFlagManager } = require('./flags/FeatureFlagManager');
const { AlertManager } = require('./alerts/AlertManager');
const { BroadcastManager } = require('./broadcast/BroadcastManager');
const { FunctionRegistry } = require('./ai/FunctionRegistry');
const { ConversationContext } = require('./ai/ConversationContext');
const { NaturalCommandRouter } = require('./ai/NaturalCommandRouter');
...
class ShiverFramework {
    constructor(userOptions = {}) {
        ...
        this.sessions = new UserSessionStore(this.options.sessions ?? {});
        this.flags = new FeatureFlagManager(null, this.options.flags ?? {});
        this.alerts = new AlertManager(this.stats, this.options.alerts ?? {});
        this.broadcast = null;
        this.ai = new FunctionRegistry();
        this.conversation = new ConversationContext(this.options.conversation ?? {});
        this.naturalRouter = new NaturalCommandRouter();
        this._storage = null;
        this._settings = null;
    ...
    async init(client) {
        ...
        this.broadcast = new BroadcastManager(client, this.options.broadcast ?? {});
        this.flags._storage = this.storage;
        if (this.options.ai?.autoLearnCommands !== false) {
            this.naturalRouter.autoLearn(this.commands.getAllSlash());
        }
...
module.exports = {
    ...
    ComponentRouter: require('./routing/ComponentRouter').ComponentRouter,
    Scheduler: require('./scheduler/Scheduler').Scheduler,
    UserSessionStore: require('./sessions/UserSessionStore').UserSessionStore,
    FeatureFlagManager: require('./flags/FeatureFlagManager').FeatureFlagManager,
    AlertManager: require('./alerts/AlertManager').AlertManager,
    BroadcastManager: require('./broadcast/BroadcastManager').BroadcastManager,
    RequestDeduplicator: require('./cache/RequestDeduplicator').RequestDeduplicator,

    FunctionRegistry: require('./ai/FunctionRegistry').FunctionRegistry,
    AIContext: require('./ai/AIContext').AIContext,
    ConversationContext: require('./ai/ConversationContext').ConversationContext,
    PromptBuilder: require('./ai/PromptBuilder').PromptBuilder,
    NaturalCommandRouter: require('./ai/NaturalCommandRouter').NaturalCommandRouter,
    StructuredOutput: require('./ai/StructuredOutput').StructuredOutput,

    WizardSession: require('./wizard/WizardSession').WizardSession,
    FormBuilder: require('./forms/FormBuilder').FormBuilder,
    VoteManager: require('./voting/VoteManager').VoteManager,
    MessageCollector: require('./collectors/MessageCollector').MessageCollector,

    HelpGenerator: require('./help/HelpGenerator').HelpGenerator,
    CommandSuggester: require('./help/CommandSuggester').CommandSuggester,
    CommandDisabledManager: require('./commands/CommandDisabledManager').CommandDisabledManager,

    TicketSystem: require('./systems/TicketSystem').TicketSystem,
    GiveawaySystem: require('./systems/GiveawaySystem').GiveawaySystem,
    TagSystem: require('./systems/TagSystem').TagSystem,
    StarboardSystem: require('./systems/StarboardSystem').StarboardSystem,

    buildProgressBar: require('./ui/ProgressBar').buildProgressBar,
    buildMultiBar: require('./ui/ProgressBar').buildMultiBar,
    TableBuilder: require('./ui/TableBuilder').TableBuilder,
    ListBuilder: require('./ui/ListBuilder').ListBuilder,

    OwnerGuard: require('./guards/Guards').OwnerGuard,
    GuildGuard: require('./guards/Guards').GuildGuard,
    ChannelGuard: require('./guards/Guards').ChannelGuard,
    RoleGuard: require('./guards/Guards').RoleGuard,
    TimeGuard: require('./guards/Guards').TimeGuard,
    RateLimitGuard: require('./guards/Guards').RateLimitGuard,

    safeRun: require('./utils/SafeExecutor').safeRun,
    withRetry: require('./utils/SafeExecutor').withRetry,
    withTimeout: require('./utils/SafeExecutor').withTimeout,

    diff: require('./utils/DiffTracker').diff,
    formatDiff: require('./utils/DiffTracker').formatDiff,

    localizeCommand: require('./locale/LocaleSync').localizeCommand,
    localizeAll: require('./locale/LocaleSync').localizeAll
};
